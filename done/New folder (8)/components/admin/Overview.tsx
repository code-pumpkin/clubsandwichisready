  ...
  return (
    <div>
      <div className="flex justify-between items-center mb-6">
        <h2 className="text-2xl font-bold">Manage your sites</h2>
        <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded inline-flex items-center">
          <Plus size={20} className="mr-2" />
          <span>New site</span>
        </button>
      </div>
      <p className="mb-8 text-gray-600">Add sites you want to monetize with DriveMaster. Learn more about managing your driving school</p>
